...
import com.group4.www.commands.listings.FilterBugsByStatus;
...
public class FilterBugsByStatusTest {
    ...
    Command filterBugsByStatus;
    Repository repository;

    @BeforeEach
    public void beforeEach(){
        repository = new RepositoryImpl();
        filterBugsByStatus = new FilterBugsByStatus(repository);
    ...
    public void execute_Should_NotThrowException_When_ValidArguments(){
        Assertions.assertDoesNotThrow(() ->filterBugsByStatus.execute(List.of(VALID_STATUS)));
    }

    @Test
    public void execute_Should_ThrowException_When_InvalidArgumentsCount(){
        Assertions.assertThrows(IllegalArgumentException.class,
                () -> filterBugsByStatus.execute(List.of()));
    }

    @Test
    public void execute_Should_ThrowException_When_InvalidArguments(){
        Assertions.assertThrows(IllegalArgumentException.class,
                () -> filterBugsByStatus.execute(List.of(INVALID_STATUS)));
    }
}
