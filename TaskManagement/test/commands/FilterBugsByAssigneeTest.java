...
public class FilterBugsByAssigneeTest {
    ...
    @Test
    public void execute_Should_ReturnCorrectListSize_When_ArgumentsValid(){
        Assertions.assertEquals(1, ListingHelper.filterByCondition((ListingHelper.listOfTasksWithAssignee(repository.getBugs()))
                ,bug -> bug.getAssignee().getName().equals(MEMBER)).size());
    }
