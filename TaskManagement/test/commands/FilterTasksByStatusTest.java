...
import com.group4.www.commands.listings.FilterTasksByStatus;
...
public class FilterTasksByStatusTest {
    ...
    public void execute_Should_NotThrowException_When_ValidArguments(){
        Assertions.assertDoesNotThrow(() ->filterTasksByStatus.execute(List.of(VALID_STATUS)));
    }

    @Test
    public void execute_Should_ThrowException_When_InvalidArgumentsCount(){
        Assertions.assertThrows(IllegalArgumentException.class,
                () -> filterTasksByStatus.execute(List.of()));
    }
